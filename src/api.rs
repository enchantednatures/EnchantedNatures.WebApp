...
pub static CLOUDFLARE_RESOURCES: LazyLock<HashMap<usize, String>> = LazyLock::new(|| {
    ...
    m.insert(126, "cb7026ee-0207-443b-5f5e-75a3b053eb00".into());
    m.insert(125, "a52bf17e-df0f-4edc-eb7b-036662053c00".into());
    m.insert(124, "ea7f65ef-6924-47cb-4859-2b71d5e6b400".into());
